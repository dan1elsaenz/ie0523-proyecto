...
module tester_receive (
    ...
    initial begin
        ...
        #10 sudi = {`K27_7_10B_RD_P,1'b1};

        #20 sudi = {`D11_3_10B_RD_N, 1'b0};  // D11.3 RD- 
        #10 sudi = {`D23_1_10B_RD_P, 1'b0};  // D23.1 RD+ 
        #10 sudi = {`D7_4_10B_RD_N, 1'b0};   // D7.4 RD- 
        #10 sudi = {`D8_6_10B_RD_P, 1'b0};  // D12.5 RD+ 
